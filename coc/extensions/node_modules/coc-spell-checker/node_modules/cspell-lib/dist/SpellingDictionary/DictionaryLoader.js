...
async function refreshEntry(entry, maxAge = MAX_AGE, now = Date.now()) {
    if (now - entry.ts >= maxAge) {
        ...
        if (entry.ts === now && ((state === null || state === void 0 ? void 0 : state.mtimeMs) !== (oldState === null || oldState === void 0 ? void 0 : oldState.mtimeMs) || (state === null || state === void 0 ? void 0 : state.size) !== (oldState === null || oldState === void 0 ? void 0 : oldState.size))) {

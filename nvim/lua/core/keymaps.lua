...
local plugsmap = {
    ...
    {mode={'n','i','t'}, input='<c-\\>', output='<cmd>ToggleTerm<cr>',         opts={silent=true} },
    ...
    {mode='n', input='<c-w>L', output='<c-w>5>', opts={silent=true}},
    {mode='n', input='<c-w>K', output='<c-w>5+', opts={silent=true}},
    {mode='n', input='<c-w>H', output='<c-w>5<', opts={silent=true}},
    {mode='n', input='<c-w>J', output='<c-w>5-', opts={silent=true}},
    ...
    -- ？？为啥不能用
    {mode='i', input='<c-h>', output='<esc><c-w>h',opts={silent=true}},
    ...
    {mode='n',input='<leader>h',output='<cmd>Telescope notify<cr>',opts={silent=true}},
    {mode='n',input='<leader>lg',output='<cmd>LazyGit<cr>', opts={silent=true}, desc = "LazyGit" },
    ...
    -- dropbar
    {mode='n', input='<leader>d',     output='<cmd>lua require("dropbar.api").pick()<cr>',     opts={silent=true}},
